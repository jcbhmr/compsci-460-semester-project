...
parser_tcp.add_argument('--bind', type=str, help='Hostname & port to bind to', default='0.0.0.0:8000')
parser_tcp.set_defaults(func=tcp.func)

parser_udp = subparser.add_parser('udp')
parser_udp.add_argument('--bind', type=str, help='Hostname & port to bind to', default='0.0.0.0:8001')
